...
interface CrewRouteGuardProps {
  children: React.ReactNode;
  requiredPermission?: string;
}

export function CrewRouteGuard({
  children,
  requiredPermission
}: CrewRouteGuardProps) {
  ...
  if (initializing || authLoading || isAuthorized === null) {
    return (
      <View style={styles.loadingContainer}>
        ...
        <Text style={styles.loadingText}>Verifying crew access...</Text>
      </View>
    );
  }
    ...
    return (
      <View style={styles.errorContainer}>
        ...
        <Text style={styles.errorMessage}>
          This area is restricted to crew members only.
        </Text>
      </View>
    );
  }
